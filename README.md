...
A key feature of the PINN is enforcement of the Black–Scholes PDE itself.
...
\sigma(S,t;\Phi)^2
S^2
\frac{\partial^2 V_\theta}{\partial S^2}
+
rS
\frac{\partial V_\theta}{\partial S}
-
rV_\theta.
$$

The required derivatives are computed using automatic differentiation in PyTorch.
...
L
=
\lambda_{\text{int}}L_{\text{int}}
+
\lambda_{\text{bc}}L_{\text{bc}}
+
\lambda_{\text{term}}L_{\text{term}}
+
